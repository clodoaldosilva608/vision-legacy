    ...
    <>
      ...
      <div className="mb-7 flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-2 animate-fade-up delay-200">
          ...
          <Link href="/dashboard/vision-board" className="gold-gradient flex items-center gap-1.5 rounded-xl px-3 py-2 text-xs font-bold text-dark shadow-sm">
      ...
      <div className="mt-5 grid gap-5 xl:grid-cols-12">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 xl:col-span-4 card-hover">
          <div className="mb-4 flex items-center justify-between">
            ...
            <Link href="/dashboard/numerologia" className="text-xs font-semibold text-accent hover:underline">Ver completo →</Link>
          </div>
        ...
        <div className="flex flex-col rounded-2xl border border-slate-200 bg-white p-5 xl:col-span-5">
          <div className="mb-3 flex items-center gap-2 border-b border-slate-100 pb-3">
            ...
            <Link href="/dashboard/ia" className="text-xs font-semibold text-accent">Abrir chat →</Link>
          </div>
