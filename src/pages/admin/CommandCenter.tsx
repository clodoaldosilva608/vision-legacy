      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-12">
        ...
        <Card title="Status crítico" dark className="lg:col-span-4">
          <div className="space-y-3">
            {[
              { t: "Serviços principais", v: "100%", c: "#00c896" },
              { t: "Latência média", v: "142ms", c: "#00c896" },
              { t: "Erros (1h)", v: "0.24%", c: "#d4af37" },
              { t: "Limite IA Gemini", v: "68%", c: "#7c5cfc" },
              { t: "Storage utilizado", v: "42%", c: "#00c896" },
              { t: "Memória RAG", v: "12GB / 50GB", c: "#3b82f6" },
            ].map((s) => (
              <div key={s.t}>
                ...
                <div className="h-2 rounded-full bg-white/5"><div className="h-2 rounded-full" style={{ width: `${60 + Math.random() * 35}%`, background: s.c }} /></div>
              </div>
            ))}
          </div>
        </Card>
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-12">
        <Card title="Top assinantes / MRR" dark className="lg:col-span-6">
          <div className="h-56">
            <ResponsiveContainer>
              <BarChart data={[
                { n: "Elite", v: 2856 }, { n: "Pro", v: 6125 }, { n: "Legacy", v: 1019 }, { n: "Free", v: 8432 },
              ]}>
                <CartesianGrid strokeDasharray="3 3" stroke="#ffffff10" vertical={false} />
